...
export HBASE_GC="-XX:+UseConcMarkSweepGC -XX:+UseParNewGC -XX:NewRatio=16 -XX:CMSInitiatingOccupancyFraction=70 -XX:+UseCMSInitiatingOccupancyOnly -XX:MaxGCPauseMillis=100"

# Comment below to disable java garbage collection logging.
export HBASE_GC="$HBASE_GC  -XX:+PrintGCTimeStamps -XX:+PrintGCDetails"
