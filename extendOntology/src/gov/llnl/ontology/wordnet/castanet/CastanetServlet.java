...
public class CastanetServlet extends HttpServlet {
	...
	try{
	    ...
	    out.println("There was an error in handling the files in the directory: "+directory);
	}
    
	
	
	// Create the keyword scores for all the words in the directory.
	Map<String, Double> keywordScores = Autosummary.calculateSakaiEtAlScore(directory, stopfile);
	sc.setAttribute("keywordScores", keywordScores);
