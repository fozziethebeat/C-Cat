...
/**
 * Implements the Jiang-Conrath Similarity.  This measure scores {@link Synset}s
 * based on the information content of their lowest common subsumer and the
 * information content of the two {@link Synset}s.  Formally, this is
 * 1 / IC({@code synset1}) + IC({@code synset2}) - 2 * IC({@code lcs}))
 *
 * @author Keith Stevens
 */
public class JiangConrathSimilarity implements SynsetSimilarity {
