...
public class SchemaUtil {
   ...
   */
  public static Object getObjectColumn(Result row, String col, String qual) {
    try {
   ...
   * column family and column qualifier.  {@code object} should implement {@link
   * Serializable}.
   */
  ...
  /**
   * Adds data to a {@link Put} under a specified column and qualifier. Returns
