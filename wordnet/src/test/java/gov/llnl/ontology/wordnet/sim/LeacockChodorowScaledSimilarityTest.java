 ...
 */
public class LeacockChodorowScaledSimilarityTest {
    ...
    @Test public void testWrongPos() {
        ...
        SynsetSimilarity sim = new LeacockChodorowScaledSimilarity(reader);
    ...
    @Test public void testSimilarity() {
        ...
        MockReader reader = new MockReader();
        SynsetSimilarity sim = new LeacockChodorowScaledSimilarity(reader);
        double max = -1 * Math.log(1/(2d*1));
        double expected = -1 * Math.log(7 / (2d * 1)) / max;
    ...
    @Test public void testSimilarityVerb() {
        ...
        MockReader reader = new MockReader();
        SynsetSimilarity sim = new LeacockChodorowScaledSimilarity(reader);
        double max = -1 * Math.log(1/(2d*2));
        double expected = -1 * Math.log(7 / (2d * 2)) / max;
        assertEquals(expected, sim.similarity(s1, s2), .0001);
    }
